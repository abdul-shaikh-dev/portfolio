  ...
  host.innerHTML = `
    ...
    <section class="knowledge-prep" aria-labelledby="prep-title">
      ...
      <div class="prep-flow" role="img" aria-label="A document is read with OCR, divided into passages, embedded, and stored with source metadata in ChromaDB">
        ...
        <div class="vault-object prep-object" data-ingest="store"><span class="object-label">Vector store</span><div class="mini-vault" aria-hidden="true"><i></i><i></i><i></i><b>semantic index</b></div><strong>ChromaDB</strong><small>passage + page + source</small></div>
    ...
    <section class="adaptive-workbench" aria-labelledby="workbench-title">
      ...
      <div class="extraction-canvas">
        ...
        <section class="evidence-vault extraction-node" data-node="store" aria-label="ChromaDB evidence library"><button type="button" class="node-jump" data-jump="store" title="Jump to retrieval"><span>Vector evidence store</span><strong>ChromaDB</strong><small>Similarity search + reranking</small></button><div class="vault-body" aria-hidden="true"><span></span><span></span><span></span><div class="vector-field">${Array.from({length:12},()=>'<i></i>').join('')}</div><b>agreement collection</b></div><div class="passage-stack"><button type="button" data-page="1"><b>01</b><span>Agreement details<small>ID · start date</small></span></button><button type="button" data-page="4"><b>04</b><span>Payment terms<small>invoice · settlement</small></span></button><button type="button" data-page="7"><b>07</b><span>Termination<small>notice · communication</small></span></button></div></section>
