...
for key in data['featuredWork']:
    ...
    if key == 'mcp':
        stories += f'''<article class="work-story story-mcp" id="project-mcp"><div class="story-heading"><p class="project-category">01 / {e(p['category'])}</p><h3>A shared foundation<br>for <em>enterprise knowledge.</em></h3></div><div class="story-layout"><div class="story-copy">{context}<p>{e(p['summary'])}</p>{tags(p['tags'])}</div>{figures[key]}<div class="lead-details">{capabilities}{technical_notes(p)}</div></div>{recognition}</article>'''
        continue
...
<link rel="stylesheet" href="css/styles.css"><link rel="stylesheet" href="css/landing.css"><script src="js/script.js" defer></script><script src="js/diagrams.js" defer></script>
</head>
<body>
...
<section class="hero" id="hero"><div class="hero-inner wrap"><div class="hero-identity"><p class="intro">Senior software engineer <span>/</span> Mumbai, India</p><h1>Abdul Gaffar<br><em>Shaikh.</em></h1><p class="hero-statement">I build backend systems and modernise applications for production.</p><p class="hero-bio">7.5+ years in financial services. Enterprise knowledge, application modernisation, and the work that takes an idea into production.</p><div class="hero-links"><a class="button" href="#project-mcp">Explore my work <span aria-hidden="true">↘</span></a>{external(linkedin,'LinkedIn')}{external(github,'GitHub')}</div></div><a class="hero-specimen" href="#project-mcp" aria-label="Explore the knowledge template and adaptive extraction"><div class="specimen-caption"><span>From my work / Knowledge systems</span><span aria-hidden="true">↗</span></div><div class="specimen-stage"><div class="specimen-document"><span class="specimen-meta">DEMO AGREEMENT <span>p. 07</span></span><p class="specimen-section">Termination</p><p class="specimen-quote">Either party may terminate with <mark>30 days’ written notice.</mark></p><div class="specimen-lines" aria-hidden="true"><i></i><i></i><i></i></div><span class="specimen-footnote">Source passage · illustrative example</span></div><div class="specimen-answer"><span class="specimen-meta">EXTRACTED FIELD <span>✓</span></span><span>Notice period</span><strong>30 <em>days</em></strong><small>Demo agreement · page 7</small></div></div><div class="specimen-bottom"><p>Knowledge,<br><em>made useful.</em></p><span>From documents to<br>answers with evidence.</span></div></a></div><nav class="hero-chapters wrap" aria-label="Explore my work"><a href="#project-mcp"><span class="chapter-number">01</span><span><strong>Enterprise knowledge</strong><small>Reusable foundations for AI</small></span><span aria-hidden="true">↗</span></a><a href="#project-modernisation"><span class="chapter-number">02</span><span><strong>Application modernisation</strong><small>From architecture to implementation</small></span><span aria-hidden="true">↗</span></a><a href="#project-engineering-support"><span class="chapter-number">03</span><span><strong>Production delivery</strong><small>Making AI applications work in practice</small></span><span aria-hidden="true">↗</span></a></nav></section>
<section class="work-section wrap" id="impact"><div class="work-header"><h2>Selected work<span>.</span></h2><p>The systems, decisions, and delivery behind the experience.</p></div><div class="work-layout"><aside class="work-navigation"><p>In this section</p><nav aria-label="Selected projects"><a href="#project-mcp">Knowledge template</a><a href="#project-modernisation">Dashboard modernisation</a><a href="#project-engineering-support">AI production delivery</a><a href="#work-index">Supporting work <span aria-hidden="true">↓</span></a></nav></aside><div class="work-stories">{stories}</div></div></section>
